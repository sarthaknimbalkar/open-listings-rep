...
export default async function (typeSense, mongoDB) {
    const schema = {
        fields: [
            ...
            { facet: true, name: 'tags', type: 'string[]' },
            { facet: false, name: 'cdesc', type: 'string' },
            { facet: true, name: 'parent', type: 'string' },
            { facet: true, name: 'granpa', type: 'string' },
            { facet: true, name: 'section', type: 'string' },
        ],
